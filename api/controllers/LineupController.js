    ...
    Lineup.find({})
      .then(function (all) {
        ...
        if (lineups.length && !extended) { //TODO provider
          ...
          return request
            .get(sails.config.tvmedia.url + '/lineups')
            .query({postalCode: zip, api_key: sails.config.tvmedia.api_key}) // TODO provider id
            .then(function (r) {
              lineups = r.body;
              aysnc.each(lineups, function (l) {
